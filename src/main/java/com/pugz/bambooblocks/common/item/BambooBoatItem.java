package com.pugz.bambooblocks.common.item;
...
public class BambooBoatItem extends Item {
    private static final Predicate<Entity> field_219989_a = EntityPredicates.NOT_SPECTATING.and(Entity::canBeCollidedWith);
    private final BambooBoatEntity.Type type;

    public BambooBoatItem(BambooBoatEntity.Type typeIn, Item.Properties properties) {
        super(properties);
        type = typeIn;
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        if (raytraceresult.getType() == RayTraceResult.Type.MISS) {
            ...
            if (raytraceresult.getType() == RayTraceResult.Type.BLOCK) {
                BambooBoatEntity boatentity = new BambooBoatEntity(worldIn, raytraceresult.getHitVec().x, raytraceresult.getHitVec().y, raytraceresult.getHitVec().z);
    ...
    static class DispenserBoatBehavior extends DefaultDispenseItemBehavior {
        ...
        public DispenserBoatBehavior(BambooBoatEntity.Type typeIn) {
            type = typeIn;
        }
        ...
        public ItemStack dispenseStack(IBlockSource iBlockSource, ItemStack stack) {
            ...
            BambooBoatEntity boat = new BambooBoatEntity(world, x, y + adjustY, z);
