package com.pugz.bambooblocks.common.entity;
...
public class BambooBoatEntity extends BoatEntity {
   ...
   private static final DataParameter<Float> DAMAGE_TAKEN = EntityDataManager.createKey(BambooBoatEntity.class, DataSerializers.FLOAT);
   private static final DataParameter<Integer> BOAT_TYPE = EntityDataManager.createKey(BambooBoatEntity.class, DataSerializers.VARINT);
   private static final DataParameter<Boolean> field_199704_e = EntityDataManager.createKey(BambooBoatEntity.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Boolean> field_199705_f = EntityDataManager.createKey(BambooBoatEntity.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Integer> ROCKING_TICKS = EntityDataManager.createKey(BambooBoatEntity.class, DataSerializers.VARINT);
   ...
   public BambooBoatEntity(EntityType<? extends BambooBoatEntity> p_i50129_1_, World p_i50129_2_) {
      super(p_i50129_1_, p_i50129_2_);
      this.preventEntitySpawning = true;
   }

   public BambooBoatEntity(World worldIn, double x, double y, double z) {
      this(BambooEntities.BOAT.get(), worldIn);
   ...
   protected void registerData() {
      ...
      this.dataManager.register(BOAT_TYPE, BambooBoatEntity.Type.BAMBOO.ordinal());
   ...
   public Item getItemBoat() {
      ...
      case BAMBOO:
      default:
         return BambooItems.BAMBOO_BOAT.get();
      }
   }
   ...
   protected void readAdditional(CompoundNBT compound) {
      if (compound.contains("Type", 8)) {
         this.setBoatType(BambooBoatEntity.Type.getTypeFromString(compound.getString("Type")));
      }
   ...
   public void setBoatType(BambooBoatEntity.Type boatType) {
      this.dataManager.set(BOAT_TYPE, boatType.ordinal());
   }

   public BambooBoatEntity.Type getBoatModel() {
      return BambooBoatEntity.Type.byId(this.dataManager.get(BOAT_TYPE));
   }
   ...
   public static enum Type {
      BAMBOO(BambooBlocks.BAMBOO_PLANKS.get(), "bamboo");
       ...
       */
      public static BambooBoatEntity.Type byId(int id) {
    	  BambooBoatEntity.Type[] aboatentity$type = values();
      ...
      public static BambooBoatEntity.Type getTypeFromString(String nameIn) {
    	  BambooBoatEntity.Type[] aboatentity$type = values();
