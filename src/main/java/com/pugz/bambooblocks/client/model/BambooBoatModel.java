package com.pugz.bambooblocks.client.model;
...
@OnlyIn(Dist.CLIENT)
public class BambooBoatModel extends SegmentedModel<BambooBoatEntity> {
    ...
    */
   @Override
   public void setRotationAngles(BambooBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
   ...
   protected void func_228244_a_(BambooBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
