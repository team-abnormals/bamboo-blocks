...
@OnlyIn(Dist.CLIENT)
public class BambooBoatModel extends EntityModel<BambooBoatEntity> {
    ...
    public void render(BambooBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    protected void renderPaddle(BambooBoatEntity boat, int paddle, float scale, float limbSwing) {
