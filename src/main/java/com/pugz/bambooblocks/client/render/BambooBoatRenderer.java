...
public class BambooBoatRenderer extends EntityRenderer<BambooBoatEntity> {
   ...
   protected final BambooBoatModel modelBoat = new BambooBoatModel();
   ...
   @Override
   public void render(BambooBoatEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      matrixStackIn.push();
    ...
    */
   @Override
   public ResourceLocation getEntityTexture(BambooBoatEntity entity) {
